...
var yeswecan = {
      ...
      build_thecamera: function() {
            ...
            mainCamera.position.z = 750; //750; // move back
            mainCamera.position.y = 150; //100; // move up
      ...
      build_theRifle: function() {
            ...
            // var dwarf = new THREE.ObjectLoader();

            // dwarf.load('assets/js/models/dwarf.js', function(mesh) {

            //       mesh.scale.set(120, 120, 120);
            //       mesh.position.set(0, 53, 231);
            //       shoot.dwarf = mesh;
      ...
      addTooth: function(i, y, z, speed, random) {
            ...
            var target_stand = new Physijs.BoxMesh(
                  new THREE.CubeGeometry(35, 4, 2, 3, 3, 3),
            ...
            // var targetTexure = THREE.ImageUtils.loadTexture('assets/img/target.jpg');
            // targetTexure.wrapS = targetTexure.wrapT = THREE.RepeatWrapping;
            // targetTexure.repeat.set(1, 1);
      ...
      build_theball: function() {
            ...
            if (shoot.rifle) {
                  ball.position.set(shoot.rifle.position.x + 0.6, shoot.rifle.position.y + 7.9, shoot.rifle.position.z - 175);
            } else {
                  ball.position.set(0.6, 57.9, 425); // ball.position.set(0, 50, 600 );
            }
